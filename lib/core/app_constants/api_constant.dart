class ApiConstant {
  static const String baseApiUrl = "http://192.168.0.105/api/";
  ...
  static const String checkSubStepExamResult =
      "${baseApiUrl}check-sub-step-result";
  static const String getSubStepExamResult =
      "${baseApiUrl}get-result-step-tests";
  ...
  static const String changeAva = "${baseApiUrl}change-avatar";
