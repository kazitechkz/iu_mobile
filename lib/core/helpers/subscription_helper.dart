...
class SubscriptionHelper {
  ...
  static List<SubscriptionEntity> getSubscriptionsByPeriod(int period) {
    return [
      SubscriptionEntity(period: 1, price: '1590', isSelected: period == 1 ? true : false, titleKk: '1 ай', titleRu: '1 мес'),
      SubscriptionEntity(period: 3, price: '3990', isSelected: period == 3 ? true : false, titleKk: '3 ай', titleRu: '3 мес'),
      SubscriptionEntity(period: 6, price: '6990', isSelected: period == 6 ? true : false, titleKk: '6 ай', titleRu: '6 мес'),
    ];
  }
}