...
class SubjectHelper {
  static List<LocalSubjectEntity> getSubjects() {
    return [
      ...
      LocalSubjectEntity(10, 'Құқық негіздері', 'Основы прав', getSubjectIconPath(10), false, 1),
      ...
      LocalSubjectEntity(15, 'Информатика', 'Информатика', getSubjectIconPath(15), false, 1),
    ];
  }
  ...
  static List<LocalSubjectEntity> getSelectedSubjects(int id, int period) {
    return [
      ...
      LocalSubjectEntity(10, 'Құқық негіздері', 'Основы прав', getSubjectIconPath(10), id == 10, period),
      ...
      LocalSubjectEntity(15, 'Информатика', 'Информатика', getSubjectIconPath(15), id == 15, period),
    ];
  }
}