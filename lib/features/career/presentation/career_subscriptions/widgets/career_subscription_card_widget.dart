...
class CareerSubscriptionCardWidget extends StatelessWidget {
  const CareerSubscriptionCardWidget({super.key,required this.careerQuizEntity});
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(child:careerQuizEntity.price > 0 ? Container(
