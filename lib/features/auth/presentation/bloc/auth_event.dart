...
class SignUpEvent extends AuthEvent{
  ...
  @override
  List<Object?> get props => [parameter.password,parameter.email,parameter.name,parameter.phone,parameter.username];
}
...
class ForgetEvent extends AuthEvent{
  ...
  @override
  List<Object?> get props => [parameter.password,parameter.email,parameter.code];
}
