...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  AuthBloc
      ({required SignInCase signInCase, required SignUpCase signUpCase, required ForgetCase forgetCase, required VerifyCase verifyCase})
  ...
  Future<void> _forgetHandler(ForgetEvent event,Emitter<AuthState> emit) async{
    emit(AuthLoadingState());
  ...
  Future<void> _verifyHandler(VerifyEvent event,Emitter<AuthState> emit) async{
    emit(AuthLoadingState());
