  ...
  return Column(
    children: [
      ...
      GFRadioListTile(
        ...
        size: 20,
        activeBorderColor: entity.result!.isRight ? Colors.green : Colors.red,
        focusColor: entity.result!.isRight ? Colors.green : Colors.red,
        radioColor: entity.result!.isRight ? Colors.green : Colors.red,
        type: GFRadioType.basic,
        value: 'a',
        groupValue: entity.result!.answer,
        onChanged: (value) {},
        inactiveIcon: null,
      ),
      GFRadioListTile(
