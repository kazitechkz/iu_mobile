...
class SubStepExamResultScreen extends StatefulWidget {
  ...
  @override
  State<SubStepExamResultScreen> createState() =>
      _SubStepExamResultScreenState();
}
...
class _SubStepExamResultScreenState extends State<SubStepExamResultScreen> {
  ...
  void initState() {
    super.initState();
    context
        .read<SubStepExamResultBloc>()
        .add(GetSubStepExamResultEvent(widget.params));
  }
        ...
        if (state is SubStepExamResultLoaded) {
          return Scaffold(
            ...
            appBar: CommonAppBarWidget(
                text: AppLocalizations.of(context)!.final_questions,
                imageUrl: 'assets/images/icons/education.webp',
                routeLink: RouteConstant.subStepDetailScreenName,
                pathParams: {
                  'subStepID': state
                      .subStepExamResults.subStepExamEntity[0].sub_step_id
                      .toString()
                }),
            body:
                getSubStepExamResultContent(state.subStepExamResults, context),
